...
export enum SubmissionStatus {
  ...
  PENDING_DELETION = 5, // An AUTO_APPROVED CREATE submission has been disapproved and the linked entity is now pending hard deletion.
}
...
export enum EntityType {
  ...
  RELEASE = 20,
  RELEASE_TRACK = 21,
  ARTIST_SUBMISSION = 50,
  RELEASE_SUBMISSION = 51,
  LABEL_SUBMISSION = 52,
  GENRE_SUBMISSION = 53,
}
...
export enum CommentEntityType {
  ...
  ARTIST_SUBMISSION = EntityType.ARTIST_SUBMISSION,
  RELEASE_SUBMISSION = EntityType.RELEASE_SUBMISSION,
  LABEL_SUBMISSION = EntityType.LABEL_SUBMISSION,
  GENRE_SUBMISSION = EntityType.GENRE_SUBMISSION,
}
